    ...
    return (
        <>
                ...
                <CardContent>
                    <div className="space-y-4">
                        {assessments.map((assessment, i) => {
                            return (
                                <Card key={assessment.id || i} className="cursor-pointer hover:bg-muted/50 transition-colors" onClick={() => setSelectedQuiz(assessment)}>
                                    <CardHeader>
            ...
            <Dialog open={!!selectedQuiz} onOpenChange={() => setSelectedQuiz(null)}>
                <DialogContent className="!max-w-[1000px] w-[95vw] max-h-[90vh] overflow-y-auto p-6">
